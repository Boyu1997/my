...
class ProductController extends Controller
{
    public function getById($id = null) {
        ...
        else
        {
            ...
            if($produce->install_id) $install = \App\Install::where('id', '=', $produce->install_id)->with('employee.user')->select('id', 'specification', 'start_at', 'end_at', 'person_hour', 'employee_id')->first();
            else $install = null;
