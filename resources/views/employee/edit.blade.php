...
@section('content')
    ...
    <form class="form-horizontal" method='POST' action='/employee/edit/id/{{$the_employee->id}}'>
        ...
        <div class="form-group sub_privilege_div">
            ...
            <div class = "col-sm-10 col-md-9">
                <select class = "form-control sub_privilege" name="maintenance" id="maintenance" value="{{ $the_employee->privilege->maintenance }}" placeholder="请输入办公手机">
        ...
        <div class="form-group sub_privilege_div">
            ...
            <div class = "col-sm-10 col-md-9">
                <select class = "form-control sub_privilege" name="sale" id="sale" value="{{ $the_employee->privilege->sale }}" placeholder="请输入办公手机">
        ...
        <div class="form-group sub_privilege_div">
            ...
            <div class = "col-sm-10 col-md-9">
                <select class = "form-control sub_privilege" name="contract" id="contract" value="{{ $the_employee->privilege->contract }}" placeholder="请输入办公手机">
        ...
        <div class="form-group sub_privilege_div">
            ...
            <div class = "col-sm-10 col-md-9">
                <select class = "form-control sub_privilege" name="trip" id="trip" value="{{ $the_employee->privilege->trip }}" placeholder="请输入办公手机">
