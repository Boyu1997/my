...
@section('content')
    ...
    <form class="form-horizontal" method='POST' action='/sale/agent/edit/id/{{ $id }}'>
        ...
        <div class="form-group">
            ...
            <div class = "col-sm-10 col-md-9">
                <input type="text" class="form-control" name="name" id="name" value="{{ $agent->name }}" placeholder="请输入代理商名称">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 col-md-9">
                <h5>{{ $agent->nation }}，{{ $agent->province }}，{{ $agent->city }}</h5>
                <div class="checkbox">
        ...
        <div class="form-group">
            ...
            <div class = "col-sm-10 col-md-9">
                <input type="text" class="form-control" name="address" id="address" value="{{ $agent->address }}" placeholder="请输入代理商地址">
        ...
        <div class="form-group">
            ...
            <div class = "col-sm-10 col-md-9">
                <input type="text" class="form-control" name="phone_number" id="phone_number" value="{{ $agent->phone_number }}" placeholder="请输入代理商电话">
        ...
        <div class="form-group">
            ...
            <div class = "col-sm-10 col-md-9">
                <input type="text" class="form-control" name="fax" id="fax" value="{{ $agent->fax }}" placeholder="请输入代理商传真">
        ...
        <div class="form-group">
            ...
            <div class = "col-sm-10 col-md-9">
                <input type="text" class="form-control" name="remark" id="remark" value="{{ $agent->remark }}" placeholder="请输入备注">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <table class='table table-bordered'>
                                    <tr><th class="table_head">姓氏</th><th>{{ $contact->last_name }}</th></tr>
                                    <tr><th class="table_head">名字</th><th>{{ $contact->first_name }}</th></tr>
                                    <tr><th class="table_head">职位</th><th>{{ $contact->job_title }}</th></tr>
                                    <tr><th class="table_head">邮箱地址</th><th>{{ $contact->email }}</th></tr>
                                    <tr><th class="table_head">电话号</th><th>{{ $contact->cellphone }}</th></tr>
                                </table>
                            </div>
                            <div class="col-md-2">
                                <button type="button" class="btn btn-danger del_contact_btn" value="{{ $contact->id }}">删除</button>
                            </div>
                        </div>
                    @endforeach
                </div>
